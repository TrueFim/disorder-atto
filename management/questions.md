...
- Does the coherence time $\tau_\mathrm{coh}$ (Mandel's definition) correlate with the momentum relaxation rate $\gamma$? (Both arise from scattering off the disordered potential, but probe different physics: interband coherence vs. intraband transport.)
