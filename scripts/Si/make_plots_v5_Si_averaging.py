...
os.makedirs("ims/disorder", exist_ok=True)
...
def plot_nonlinear_response_v4_averaging(folders, ax):
    ...
    # plt.savefig("ims/all/" + folder + ".pdf")
    plt.savefig("ims/all/" + folder + '_averaged' + ".png", dpi=200)
...
def plot_nonlinear_response_v5_averaging_disorder(folders_dict, ax):
    ...
    for j, key in enumerate(keys):
        ...
        # plt.savefig("ims/all/" + folder + ".pdf")
        plt.savefig("ims/disorder/" + 'disorder_comparison' + ".png", dpi=200)
...
folders = [f for f in folders 
           ...
           and os.path.isfile(os.path.join(f, 'lr_rt.data')) 
