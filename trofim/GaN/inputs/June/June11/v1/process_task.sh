...
srun -n $SLURM_JOB_NUM_NODES ~/local/bin/salmon < GaN_gs_*.inp > OUTPUT_DFT.out
...
srun -n $SLURM_JOB_NUM_NODES ~/local/bin/salmon < GaN_weak_rt_pulse_*.inp > OUTPUT_weak_pulse.out
srun -n $SLURM_JOB_NUM_NODES ~/local/bin/salmon < GaN_rt_pulse_*.inp > OUTPUT_strong_pulse.out
srun -n $SLURM_JOB_NUM_NODES ~/local/bin/salmon < GaN_response_rt_pulse_*.inp > OUTPUT_linear_response.out
