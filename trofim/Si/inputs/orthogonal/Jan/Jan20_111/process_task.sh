...
srun -n $SLURM_JOB_NUM_NODES ~/local/bin/salmon < Si_rt_both*.inp > OUTPUT_both_pulses.out
srun -n $SLURM_JOB_NUM_NODES ~/local/bin/salmon < Si_rt_probe*.inp > OUTPUT_probe_pulse.out
srun -n $SLURM_JOB_NUM_NODES ~/local/bin/salmon < Si_rt_pump*.inp > OUTPUT_pump_pulse.out
