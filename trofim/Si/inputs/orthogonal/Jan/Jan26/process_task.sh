...
srun -n 9000 ~/local/bin/salmon < Si_gs_*.inp > OUTPUT_DFT.out
...
srun -n 9000 ~/local/bin/salmon < Si_rt_both*.inp > OUTPUT_both_pulses.out
srun -n 9000 ~/local/bin/salmon < Si_rt_probe*.inp > OUTPUT_probe_pulse.out
srun -n 9000 ~/local/bin/salmon < Si_rt_pump*.inp > OUTPUT_pump_pulse.out
